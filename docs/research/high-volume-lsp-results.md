...
> **文档状态（2026-07-19）：** 本文同时保留优化前审计和后续路线图。源码链接到
> `3816df9` 的段落描述优化前基线；“本轮交付边界与实测”记录 `bc3df37`。当前保证
> 以 [`docs/spec.md`](../spec.md) 为准，当前 benchmark 实际覆盖以
> [`README.md`](../../README.md) 和 benchmark 源码为准。
...
| 本仓库优化前审计基线 | `3816df9f4dedcb8e2be922c56f85984949be184b` |
| 本仓库实测版本 | `bc3df3778655` |
...
路由在客户端看到结果前就已失效
（[`eglotx.el` L130-L137](https://github.com/cxa/eglotx/blob/3816df9f4dedcb8e2be922c56f85984949be184b/eglotx.el#L130-L137)、
[`eglotx--tag-owned-object` L3612-L3653](https://github.com/cxa/eglotx/blob/3816df9f4dedcb8e2be922c56f85984949be184b/eglotx.el#L3612-L3653)）。这同时是性能问题和
正确性问题。
...
对应源码是
[`eglotx--completion-default` / `--completion-parts` L6618-L6659](https://github.com/cxa/eglotx/blob/3816df9f4dedcb8e2be922c56f85984949be184b/eglotx.el#L6618-L6659)、
[`eglotx--merge-completions` L6661-L6676](https://github.com/cxa/eglotx/blob/3816df9f4dedcb8e2be922c56f85984949be184b/eglotx.el#L6661-L6676)、
[`eglotx--tag-sequence` L3655-L3666](https://github.com/cxa/eglotx/blob/3816df9f4dedcb8e2be922c56f85984949be184b/eglotx.el#L3655-L3666) 和
[`eglotx--tag-owned-object` L3612-L3653](https://github.com/cxa/eglotx/blob/3816df9f4dedcb8e2be922c56f85984949be184b/eglotx.el#L3612-L3653)。
...
P0–P3 已在 `bc3df37` 落地；P4 是独立的未来路线图，不属于当前实现承诺。
